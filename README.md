...
<p align="center">
  <img src="assets/grid.png" width="100%" />
  <br>
  <sub>Images generated by the Persian miniature LoRA I trained</sub>
</p>

## Components

- From-scratch base model: CLIP text encoder, VAE, and UNet
- Samplers: DDPM and DDIM implemented from scratch, Euler sampler is in progress
- LoRA: custom linear layers with training code
- txt2img and img2img (no inpainting) inference 
...
stable-diffusion-rebuilt/
├── src/
│   ├── stablediffusion/   # from-scratch VAE, CLIP text encoder, UNet
...
│   └── convert_weights.py # load SD1.5 checkpoint into the from-scratch modules in stablediffusion/
├── scripts/
